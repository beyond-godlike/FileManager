...
val categories = listOf(
    CategoryItem(R.drawable.download_24, R.string.downloads, "", Screen.DownloadsScreen.route),
    ...
    CategoryItem(R.drawable.audio_24, R.string.audio, "0 mb", Screen.AudioScreen.route),
    CategoryItem(R.drawable.document_24, R.string.documents, "", Screen.DocumentsScreen.route),
    CategoryItem(R.drawable.apps_24, R.string.applications, "", Screen.AppsScreen.route)
)
